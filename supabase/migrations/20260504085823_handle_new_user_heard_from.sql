-- Update handle_new_user to store heard_from from signup metadata
...
BEGIN
  ...
  INSERT INTO public.profiles (user_id, full_name, email, phone, referral_code, referred_by, heard_from)
  VALUES (
    NEW.id,
  ...
  ON CONFLICT (user_id) DO UPDATE SET
    ...
    heard_from   = COALESCE(profiles.heard_from, NEW.raw_user_meta_data->>'heard_from');
